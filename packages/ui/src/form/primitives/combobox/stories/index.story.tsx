...
const meta: Meta< typeof Combobox.Root > = {
	...
	parameters: {
		// FIXME: Placeholder-like trigger text fails color-contrast (WCAG 1.4.3 applies to placeholder text). Stories also need a visible label on the trigger (button-name) — update examples to include Field.Label rather than relying on aria-label. Detached Inline also lacks accessible names/required ARIA and uses a non-keyboard-accessible scroll region (aria-input-field-name, aria-required-attr, scrollable-region-focusable).
